...
using ConstraintDFGEdge  = ConstraintScalar<BackendLLVMEdge<&FunctionWrapper::dfg, &FunctionWrapper::rdfg>,2>;
using ConstraintCFGEdge  = ConstraintScalar<BackendLLVMEdge<&FunctionWrapper::cfg, &FunctionWrapper::rcfg>,2>;
...
using ConstraintDFGDominateStrict = ConstraintVector<BackendLLVMDominate<false, false, 0, &FunctionWrapper:: dfg>,3>;
using ConstraintDFGPostdomStrict  = ConstraintVector<BackendLLVMDominate<false, false, 1, &FunctionWrapper::rdfg>,3>;

using ConstraintCFGDominate       = ConstraintVector<BackendLLVMDominate<false, true,  2, &FunctionWrapper:: cfg>,3>;
using ConstraintCFGPostdom        = ConstraintVector<BackendLLVMDominate<false, true,  3, &FunctionWrapper::rcfg>,3>;
using ConstraintCFGDominateStrict = ConstraintVector<BackendLLVMDominate<false, false, 2, &FunctionWrapper:: cfg>,3>;
using ConstraintCFGPostdomStrict  = ConstraintVector<BackendLLVMDominate<false, false, 3, &FunctionWrapper::rcfg>,3>;

using ConstraintPDGDominate       = ConstraintVector<BackendLLVMDominate<false, true,  4, &FunctionWrapper:: pdg>,3>;
using ConstraintPDGPostdom        = ConstraintVector<BackendLLVMDominate<false, true,  5, &FunctionWrapper::rpdg>,3>;
using ConstraintPDGDominateStrict = ConstraintVector<BackendLLVMDominate<false, false, 4, &FunctionWrapper:: pdg>,3>;
using ConstraintPDGPostdomStrict  = ConstraintVector<BackendLLVMDominate<false, false, 5, &FunctionWrapper::rpdg>,3>;

using ConstraintDFGNotDominate       = ConstraintVector<BackendLLVMDominate<true, true,  0, &FunctionWrapper:: dfg>,3>;
using ConstraintDFGNotPostdom        = ConstraintVector<BackendLLVMDominate<true, true,  1, &FunctionWrapper::rdfg>,3>;
using ConstraintDFGNotDominateStrict = ConstraintVector<BackendLLVMDominate<true, false, 0, &FunctionWrapper:: dfg>,3>;
using ConstraintDFGNotPostdomStrict  = ConstraintVector<BackendLLVMDominate<true, false, 1, &FunctionWrapper::rdfg>,3>;

using ConstraintCFGNotDominate       = ConstraintVector<BackendLLVMDominate<true, true,  2, &FunctionWrapper:: cfg>,3>;
using ConstraintCFGNotPostdom        = ConstraintVector<BackendLLVMDominate<true, true,  3, &FunctionWrapper::rcfg>,3>;
using ConstraintCFGNotDominateStrict = ConstraintVector<BackendLLVMDominate<true, false, 2, &FunctionWrapper:: cfg>,3>;
using ConstraintCFGNotPostdomStrict  = ConstraintVector<BackendLLVMDominate<true, false, 3, &FunctionWrapper::rcfg>,3>;

using ConstraintPDGNotDominate       = ConstraintVector<BackendLLVMDominate<true, true,  4, &FunctionWrapper:: pdg>,3>;
using ConstraintPDGNotPostdom        = ConstraintVector<BackendLLVMDominate<true, true,  5, &FunctionWrapper::rpdg>,3>;
using ConstraintPDGNotDominateStrict = ConstraintVector<BackendLLVMDominate<true, false, 4, &FunctionWrapper:: pdg>,3>;
using ConstraintPDGNotPostdomStrict  = ConstraintVector<BackendLLVMDominate<true, false, 5, &FunctionWrapper::rpdg>,3>;

using ConstraintCFGBlocked = ConstraintVector<BackendLLVMDominate<false, false, UINT_MAX, &FunctionWrapper::cfg>,3>;
using ConstraintDFGBlocked = ConstraintVector<BackendLLVMDominate<false, false, UINT_MAX, &FunctionWrapper::dfg>,3>;
using ConstraintPDGBlocked = ConstraintVector<BackendLLVMDominate<false, false, UINT_MAX, &FunctionWrapper::pdg>,3>;
