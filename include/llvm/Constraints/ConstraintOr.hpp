...
public:
    template<typename T1, typename T2,
        ...
        typename std::enable_if< std::is_base_of<ConstraintOr,T1>::value>::type* = nullptr,
        typename std::enable_if<!std::is_base_of<ConstraintOr,T2>::value>::type* = nullptr>
    ConstraintOr(T1 const1, T2 const2)
    {
