...
prettyprint ((PNode "calculation" cont):xs) = prettyprint cont++prettyprint xs
prettyprint ((PNode "rawinherit" cont):xs) = prettyprint cont++prettyprint xs
prettyprint ((PNode "arginherit" cont):xs) = prettyprint cont++prettyprint xs
prettyprint ((PNode "grouping" cont):xs) = prettyprint cont++prettyprint xs
