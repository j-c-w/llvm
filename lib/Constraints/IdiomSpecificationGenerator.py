...
grammar = "[('#', ['<specification>']), ('@235', ['Constraint']), ('@236', ['<@235>', '<s>']), ('@237', ['<@236>', '<constraint>']), ('specification', ['<@237>', 'End']), ('constraint', ['<grouping>']), ('constraint', ['<collect>']), ('constraint', ['<rename>']), ('constraint', ['<rebase>']), ('constraint', ['<atom>']), ('constraint', ['<GeneralizedDominance>']), ('constraint', ['<GeneralizedSame>']), ('@238', ['(']), ('@239', ['<@238>', '<constraint>']), ('constraint', ['<@239>', ')']), ('grouping', ['<conjunction>']), ('grouping', ['<disjunction>']), ('grouping', ['<inheritance>']), ('grouping', ['<forall>']), ('grouping', ['<forsome>']), ('grouping', ['<forone>']), ('grouping', ['<if>']), ('grouping', ['<default>']), ('inheritance', ['<rawinherit>']), ('inheritance', ['<arginherit>']), ('@240', ['include']), ('rawinherit', ['<@240>', '<s>']), ('@241', ['<rawinherit>', '(']), ('@242', ['<@241>', '<s>']), ('@243', ['<@242>', '=']), ('@arginheritbase', ['<@243>', '<calculation>']), ('@244', ['<@arginheritbase>', ',']), ('@245', ['<@244>', '<s>']), ('@246', ['<@245>', '=']), ('@arginheritcont', ['<@246>', '<calculation>']), ('@247', ['<@arginheritcont>', ',']), ('@248', ['<@247>', '<s>']), ('@249', ['<@248>', '=']), ('@arginheritcont', ['<@249>', '<calculation>']), ('arginherit', ['<@arginheritcont>', ')']), ('arginherit', ['<@arginheritbase>', ')']), ('@252', ['<@239>', 'and']), ('@conjunctionbase', ['<@252>', '<constraint>']), ('@253', ['<@conjunctionbase>', 'and']), ('@conjunctioncont', ['<@253>', '<constraint>']), ('@254', ['<@conjunctioncont>', 'and']), ('@conjunctioncont', ['<@254>', '<constraint>']), ('conjunction', ['<@conjunctioncont>', ')']), ('conjunction', ['<@conjunctionbase>', ')']), ('@257', ['<@239>', 'or']), ('@disjunctionbase', ['<@257>', '<constraint>']), ('@258', ['<@disjunctionbase>', 'or']), ('@disjunctioncont', ['<@258>', '<constraint>']), ('@259', ['<@disjunctioncont>', 'or']), ('@disjunctioncont', ['<@259>', '<constraint>']), ('disjunction', ['<@disjunctioncont>', ')']), ('disjunction', ['<@disjunctionbase>', ')']), ('@260', ['<constraint>', 'for']), ('@261', ['<@260>', 'all']), ('@262', ['<@261>', '<s>']), ('@263', ['<@262>', '=']), ('@264', ['<@263>', '<calculation>']), ('@265', ['<@264>', '..']), ('forall', ['<@265>', '<calculation>']), ('@267', ['<@260>', 'some']), ('@268', ['<@267>', '<s>']), ('@269', ['<@268>', '=']), ('@270', ['<@269>', '<calculation>']), ('@271', ['<@270>', '..']), ('forsome', ['<@271>', '<calculation>']), ('@273', ['<@260>', '<s>']), ('@274', ['<@273>', '=']), ('forone', ['<@274>', '<calculation>']), ('@278', ['<@274>', '<calculation>']), ('@279', ['<@278>', 'if']), ('@280', ['<@279>', 'not']), ('@281', ['<@280>', 'otherwise']), ('default', ['<@281>', 'specified']), ('@282', ['if']), ('@283', ['<@282>', '<calculation>']), ('@284', ['<@283>', '=']), ('@285', ['<@284>', '<calculation>']), ('@286', ['<@285>', 'then']), ('@287', ['<@286>', '<constraint>']), ('@288', ['<@287>', 'else']), ('@289', ['<@288>', '<constraint>']), ('if', ['<@289>', 'endif']), ('@290', ['collect']), ('@291', ['<@290>', '<s>']), ('@292', ['<@291>', '<n>']), ('collect', ['<@292>', '<constraint>']), ('@293', ['<grouping>', 'with']), ('@294', ['<@293>', '<slot>']), ('@295', ['<@294>', 'as']), ('@renamebase', ['<@295>', '<slot>']), ('@296', ['<@renamebase>', 'and']), ('@297', ['<@296>', '<slot>']), ('@298', ['<@297>', 'as']), ('@renamecont', ['<@298>', '<slot>']), ('@299', ['<@renamecont>', 'and']), ('@300', ['<@299>', '<slot>']), ('@301', ['<@300>', 'as']), ('@renamecont', ['<@301>', '<slot>']), ('rename', ['<@renamecont>']), ('rename', ['<@renamebase>']), ('@302', ['<grouping>', 'at']), ('rebase', ['<@302>', '<slot>']), ('@303', ['<rename>', 'at']), ('rebase', ['<@303>', '<slot>']), ('@304', ['{']), ('@305', ['<@304>', '<openslot>']), ('slot', ['<@305>', '}']), ('slot', ['<slottuple>']), ('openslot', ['<slotbase>']), ('openslot', ['<slotindex>']), ('openslot', ['<slotrange>']), ('openslot', ['<slotmember>']), ('openslot', ['<slottuple>']), ('slotbase', ['<s>']), ('@306', ['<openslot>', '[']), ('@307', ['<@306>', '<calculation>']), ('slotindex', ['<@307>', ']']), ('@310', ['<@307>', '..']), ('@311', ['<@310>', '<calculation>']), ('slotrange', ['<@311>', ']']), ('@312', ['<openslot>', '.']), ('slotmember', ['<@312>', '<s>']), ('@slottuplebase', ['<@305>', ',']), ('@315', ['<@slottuplebase>', '<openslot>']), ('@slottuplecont', ['<@315>', ',']), ('@316', ['<@slottuplecont>', '<openslot>']), ('@slottuplecont', ['<@316>', ',']), ('slottuple', ['<@316>', '}']), ('slottuple', ['<@315>', '}']), ('calculation', ['<basevar>']), ('calculation', ['<baseconst>']), ('calculation', ['<addvar>']), ('calculation', ['<addconst>']), ('calculation', ['<subvar>']), ('calculation', ['<subconst>']), ('basevar', ['<s>']), ('baseconst', ['<n>']), ('@319', ['<calculation>', '+']), ('addvar', ['<@319>', '<s>']), ('addconst', ['<@319>', '<n>']), ('@321', ['<calculation>', '-']), ('subvar', ['<@321>', '<s>']), ('subconst', ['<@321>', '<n>']), ('atom', ['<ConstraintIntegerType>']), ('atom', ['<ConstraintFloatType>']), ('atom', ['<ConstraintVectorType>']), ('atom', ['<ConstraintPointerType>']), ('atom', ['<ConstraintIntZero>']), ('atom', ['<ConstraintFloatZero>']), ('atom', ['<ConstraintUnused>']), ('atom', ['<ConstraintNotNumericConstant>']), ('atom', ['<ConstraintConstant>']), ('atom', ['<ConstraintPreexecution>']), ('atom', ['<ConstraintArgument>']), ('atom', ['<ConstraintInstruction>']), ('atom', ['<ConstraintStoreInst>']), ('atom', ['<ConstraintLoadInst>']), ('atom', ['<ConstraintReturnInst>']), ('atom', ['<ConstraintBranchInst>']), ('atom', ['<ConstraintAddInst>']), ('atom', ['<ConstraintSubInst>']), ('atom', ['<ConstraintMulInst>']), ('atom', ['<ConstraintFAddInst>']), ('atom', ['<ConstraintFSubInst>']), ('atom', ['<ConstraintFMulInst>']), ('atom', ['<ConstraintFDivInst>']), ('atom', ['<ConstraintBitOrInst>']), ('atom', ['<ConstraintBitAndInst>']), ('atom', ['<ConstraintBitcastInst>']), ('atom', ['<ConstraintLShiftInst>']), ('atom', ['<ConstraintSelectInst>']), ('atom', ['<ConstraintSExtInst>']), ('atom', ['<ConstraintZExtInst>']), ('atom', ['<ConstraintGEPInst>']), ('atom', ['<ConstraintICmpInst>']), ('atom', ['<ConstraintCallInst>']), ('atom', ['<ConstraintShufflevectorInst>']), ('atom', ['<ConstraintInsertelementInst>']), ('atom', ['<ConstraintSame>']), ('atom', ['<ConstraintDistinct>']), ('atom', ['<ConstraintDFGEdge>']), ('atom', ['<ConstraintCFGEdge>']), ('atom', ['<ConstraintCDGEdge>']), ('atom', ['<ConstraintPDGEdge>']), ('atom', ['<ConstraintFirstOperand>']), ('atom', ['<ConstraintSecondOperand>']), ('atom', ['<ConstraintThirdOperand>']), ('atom', ['<ConstraintFourthOperand>']), ('atom', ['<ConstraintFirstSuccessor>']), ('atom', ['<ConstraintSecondSuccessor>']), ('atom', ['<ConstraintThirdSuccessor>']), ('atom', ['<ConstraintFourthSuccessor>']), ('atom', ['<ConstraintDFGDominate>']), ('atom', ['<ConstraintDFGPostdom>']), ('atom', ['<ConstraintDFGDominateStrict>']), ('atom', ['<ConstraintDFGPostdomStrict>']), ('atom', ['<ConstraintCFGDominate>']), ('atom', ['<ConstraintCFGPostdom>']), ('atom', ['<ConstraintCFGDominateStrict>']), ('atom', ['<ConstraintCFGPostdomStrict>']), ('atom', ['<ConstraintPDGDominate>']), ('atom', ['<ConstraintPDGPostdom>']), ('atom', ['<ConstraintPDGDominateStrict>']), ('atom', ['<ConstraintPDGPostdomStrict>']), ('atom', ['<ConstraintDFGNotDominate>']), ('atom', ['<ConstraintDFGNotPostdom>']), ('atom', ['<ConstraintDFGNotDominateStrict>']), ('atom', ['<ConstraintDFGNotPostdomStrict>']), ('atom', ['<ConstraintCFGNotDominate>']), ('atom', ['<ConstraintCFGNotPostdom>']), ('atom', ['<ConstraintCFGNotDominateStrict>']), ('atom', ['<ConstraintCFGNotPostdomStrict>']), ('atom', ['<ConstraintPDGNotDominate>']), ('atom', ['<ConstraintPDGNotPostdom>']), ('atom', ['<ConstraintPDGNotDominateStrict>']), ('atom', ['<ConstraintPDGNotPostdomStrict>']), ('atom', ['<ConstraintIncomingValue>']), ('atom', ['<ConstraintDFGBlocked>']), ('atom', ['<ConstraintCFGBlocked>']), ('atom', ['<ConstraintPDGBlocked>']), ('atom', ['<ConstraintFunctionAttribute>']), ('@323', ['<slot>', 'is']), ('@324', ['<@323>', 'an']), ('ConstraintIntegerType', ['<@324>', 'integer']), ('@326', ['<@323>', 'a']), ('ConstraintFloatType', ['<@326>', 'float']), ('ConstraintVectorType', ['<@326>', 'vector']), ('ConstraintPointerType', ['<@326>', 'pointer']), ('@332', ['<@323>', 'integer']), ('ConstraintIntZero', ['<@332>', 'zero']), ('@334', ['<@323>', 'floating']), ('@335', ['<@334>', 'point']), ('ConstraintFloatZero', ['<@335>', 'zero']), ('ConstraintUnused', ['<@323>', 'unused']), ('@338', ['<@323>', 'not']), ('@339', ['<@338>', 'a']), ('@340', ['<@339>', 'numeric']), ('ConstraintNotNumericConstant', ['<@340>', 'constant']), ('ConstraintConstant', ['<@326>', 'constant']), ('ConstraintPreexecution', ['<@323>', 'preexecution']), ('ConstraintArgument', ['<@324>', 'argument']), ('ConstraintInstruction', ['<@324>', 'instruction']), ('@349', ['<@323>', 'store']), ('ConstraintStoreInst', ['<@349>', 'instruction']), ('@351', ['<@323>', 'load']), ('ConstraintLoadInst', ['<@351>', 'instruction']), ('@353', ['<@323>', 'return']), ('ConstraintReturnInst', ['<@353>', 'instruction']), ('@355', ['<@323>', 'branch']), ('ConstraintBranchInst', ['<@355>', 'instruction']), ('@357', ['<@323>', 'add']), ('ConstraintAddInst', ['<@357>', 'instruction']), ('@359', ['<@323>', 'sub']), ('ConstraintSubInst', ['<@359>', 'instruction']), ('@361', ['<@323>', 'mul']), ('ConstraintMulInst', ['<@361>', 'instruction']), ('@363', ['<@323>', 'fadd']), ('ConstraintFAddInst', ['<@363>', 'instruction']), ('@365', ['<@323>', 'fsub']), ('ConstraintFSubInst', ['<@365>', 'instruction']), ('@367', ['<@323>', 'fmul']), ('ConstraintFMulInst', ['<@367>', 'instruction']), ('@369', ['<@323>', 'fdiv']), ('ConstraintFDivInst', ['<@369>', 'instruction']), ('@371', ['<@323>', 'bitor']), ('ConstraintBitOrInst', ['<@371>', 'instruction']), ('@373', ['<@323>', 'bitand']), ('ConstraintBitAndInst', ['<@373>', 'instruction']), ('@375', ['<@323>', 'lshift']), ('ConstraintLShiftInst', ['<@375>', 'instruction']), ('@377', ['<@323>', 'select']), ('ConstraintSelectInst', ['<@377>', 'instruction']), ('@379', ['<@323>', 'bitcast']), ('ConstraintBitcastInst', ['<@379>', 'instruction']), ('@381', ['<@323>', 'sext']), ('ConstraintSExtInst', ['<@381>', 'instruction']), ('@383', ['<@323>', 'zext']), ('ConstraintZExtInst', ['<@383>', 'instruction']), ('@385', ['<@323>', 'gep']), ('ConstraintGEPInst', ['<@385>', 'instruction']), ('@387', ['<@323>', 'icmp']), ('ConstraintICmpInst', ['<@387>', 'instruction']), ('@389', ['<@323>', 'call']), ('ConstraintCallInst', ['<@389>', 'instruction']), ('@391', ['<@323>', 'shufflevector']), ('ConstraintShufflevectorInst', ['<@391>', 'instruction']), ('@393', ['<@323>', 'insertelement']), ('ConstraintInsertelementInst', ['<@393>', 'instruction']), ('@395', ['<@323>', 'the']), ('@396', ['<@395>', 'same']), ('@397', ['<@396>', 'as']), ('ConstraintSame', ['<@397>', '<slot>']), ('@400', ['<@338>', 'the']), ('@401', ['<@400>', 'same']), ('@402', ['<@401>', 'as']), ('ConstraintDistinct', ['<@402>', '<slot>']), ('@403', ['<slot>', 'has']), ('@404', ['<@403>', 'data']), ('@405', ['<@404>', 'flow']), ('@406', ['<@405>', 'to']), ('ConstraintDFGEdge', ['<@406>', '<slot>']), ('@408', ['<@403>', 'control']), ('@409', ['<@408>', 'flow']), ('@410', ['<@409>', 'to']), ('ConstraintCFGEdge', ['<@410>', '<slot>']), ('@413', ['<@408>', 'dominance']), ('@414', ['<@413>', 'to']), ('ConstraintCDGEdge', ['<@414>', '<slot>']), ('@416', ['<@403>', 'dependence']), ('@417', ['<@416>', 'edge']), ('@418', ['<@417>', 'to']), ('ConstraintPDGEdge', ['<@418>', '<slot>']), ('@420', ['<@323>', 'first']), ('@421', ['<@420>', 'argument']), ('@422', ['<@421>', 'of']), ('ConstraintFirstOperand', ['<@422>', '<slot>']), ('@424', ['<@323>', 'second']), ('@425', ['<@424>', 'argument']), ('@426', ['<@425>', 'of']), ('ConstraintSecondOperand', ['<@426>', '<slot>']), ('@428', ['<@323>', 'third']), ('@429', ['<@428>', 'argument']), ('@430', ['<@429>', 'of']), ('ConstraintThirdOperand', ['<@430>', '<slot>']), ('@432', ['<@323>', 'fourth']), ('@433', ['<@432>', 'argument']), ('@434', ['<@433>', 'of']), ('ConstraintFourthOperand', ['<@434>', '<slot>']), ('@437', ['<@420>', 'successor']), ('@438', ['<@437>', 'of']), ('ConstraintFirstSuccessor', ['<@438>', '<slot>']), ('@441', ['<@424>', 'successor']), ('@442', ['<@441>', 'of']), ('ConstraintSecondSuccessor', ['<@442>', '<slot>']), ('@445', ['<@428>', 'successor']), ('@446', ['<@445>', 'of']), ('ConstraintThirdSuccessor', ['<@446>', '<slot>']), ('@449', ['<@432>', 'successor']), ('@450', ['<@449>', 'of']), ('ConstraintFourthSuccessor', ['<@450>', '<slot>']), ('@451', ['<slot>', 'data']), ('@452', ['<@451>', 'flow']), ('@453', ['<@452>', 'dominates']), ('ConstraintDFGDominate', ['<@453>', '<slot>']), ('@456', ['<@452>', 'post']), ('@457', ['<@456>', 'dominates']), ('ConstraintDFGPostdom', ['<@457>', '<slot>']), ('@458', ['<slot>', 'strictly']), ('@459', ['<@458>', 'data']), ('@460', ['<@459>', 'flow']), ('@461', ['<@460>', 'dominates']), ('ConstraintDFGDominateStrict', ['<@461>', '<slot>']), ('@465', ['<@460>', 'post']), ('@466', ['<@465>', 'dominates']), ('ConstraintDFGPostdomStrict', ['<@466>', '<slot>']), ('@467', ['<slot>', 'control']), ('@468', ['<@467>', 'flow']), ('@469', ['<@468>', 'dominates']), ('ConstraintCFGDominate', ['<@469>', '<slot>']), ('@472', ['<@468>', 'post']), ('@473', ['<@472>', 'dominates']), ('ConstraintCFGPostdom', ['<@473>', '<slot>']), ('@475', ['<@458>', 'control']), ('@476', ['<@475>', 'flow']), ('@477', ['<@476>', 'dominates']), ('ConstraintCFGDominateStrict', ['<@477>', '<slot>']), ('@481', ['<@476>', 'post']), ('@482', ['<@481>', 'dominates']), ('ConstraintCFGPostdomStrict', ['<@482>', '<slot>']), ('@483', ['<slot>', 'dominates']), ('ConstraintPDGDominate', ['<@483>', '<slot>']), ('@484', ['<slot>', 'post']), ('@485', ['<@484>', 'dominates']), ('ConstraintPDGPostdom', ['<@485>', '<slot>']), ('@487', ['<@458>', 'dominates']), ('ConstraintPDGDominateStrict', ['<@487>', '<slot>']), ('@489', ['<@458>', 'post']), ('@490', ['<@489>', 'dominates']), ('ConstraintPDGPostdomStrict', ['<@490>', '<slot>']), ('@491', ['<slot>', 'does']), ('@492', ['<@491>', 'not']), ('@493', ['<@492>', 'data']), ('@494', ['<@493>', 'flow']), ('@495', ['<@494>', 'dominate']), ('ConstraintDFGNotDominate', ['<@495>', '<slot>']), ('@500', ['<@494>', 'post']), ('@501', ['<@500>', 'dominate']), ('ConstraintDFGNotPostdom', ['<@501>', '<slot>']), ('@504', ['<@492>', 'strictly']), ('@505', ['<@504>', 'data']), ('@506', ['<@505>', 'flow']), ('@507', ['<@506>', 'dominate']), ('ConstraintDFGNotDominateStrict', ['<@507>', '<slot>']), ('@513', ['<@506>', 'post']), ('@514', ['<@513>', 'dominate']), ('ConstraintDFGNotPostdomStrict', ['<@514>', '<slot>']), ('@517', ['<@492>', 'control']), ('@518', ['<@517>', 'flow']), ('@519', ['<@518>', 'dominate']), ('ConstraintCFGNotDominate', ['<@519>', '<slot>']), ('@524', ['<@518>', 'post']), ('@525', ['<@524>', 'dominate']), ('ConstraintCFGNotPostdom', ['<@525>', '<slot>']), ('@529', ['<@504>', 'control']), ('@530', ['<@529>', 'flow']), ('@531', ['<@530>', 'dominate']), ('ConstraintCFGNotDominateStrict', ['<@531>', '<slot>']), ('@537', ['<@530>', 'post']), ('@538', ['<@537>', 'dominate']), ('ConstraintCFGNotPostdomStrict', ['<@538>', '<slot>']), ('@541', ['<@492>', 'dominate']), ('ConstraintPDGNotDominate', ['<@541>', '<slot>']), ('@544', ['<@492>', 'post']), ('@545', ['<@544>', 'dominate']), ('ConstraintPDGNotPostdom', ['<@545>', '<slot>']), ('@549', ['<@504>', 'dominate']), ('ConstraintPDGNotDominateStrict', ['<@549>', '<slot>']), ('@553', ['<@504>', 'post']), ('@554', ['<@553>', 'dominate']), ('ConstraintPDGNotPostdomStrict', ['<@554>', '<slot>']), ('@555', ['<slot>', 'reaches']), ('@556', ['<@555>', 'phi']), ('@557', ['<@556>', 'node']), ('@558', ['<@557>', '<slot>']), ('@559', ['<@558>', 'from']), ('ConstraintIncomingValue', ['<@559>', '<slot>']), ('@560', ['all']), ('@561', ['<@560>', 'data']), ('@562', ['<@561>', 'flow']), ('@563', ['<@562>', 'from']), ('@564', ['<@563>', '<slot>']), ('@565', ['<@564>', 'to']), ('@566', ['<@565>', '<slot>']), ('@567', ['<@566>', 'passes']), ('@568', ['<@567>', 'through']), ('ConstraintDFGBlocked', ['<@568>', '<slot>']), ('@570', ['<@560>', 'control']), ('@571', ['<@570>', 'flow']), ('@572', ['<@571>', 'from']), ('@573', ['<@572>', '<slot>']), ('@574', ['<@573>', 'to']), ('@575', ['<@574>', '<slot>']), ('@576', ['<@575>', 'passes']), ('@577', ['<@576>', 'through']), ('ConstraintCFGBlocked', ['<@577>', '<slot>']), ('@579', ['<@560>', 'flow']), ('@580', ['<@579>', 'from']), ('@581', ['<@580>', '<slot>']), ('@582', ['<@581>', 'to']), ('@583', ['<@582>', '<slot>']), ('@584', ['<@583>', 'passes']), ('@585', ['<@584>', 'through']), ('ConstraintPDGBlocked', ['<@585>', '<slot>']), ('@587', ['<@403>', 'attribute']), ('ConstraintFunctionAttribute', ['<@587>', 'pure']), ('@591', ['<@396>', 'set']), ('@592', ['<@591>', 'as']), ('GeneralizedSame', ['<@592>', '<slot>']), ('@597', ['<@581>', 'or']), ('@598', ['<@597>', 'any']), ('@599', ['<@598>', 'origin']), ('@600', ['<@599>', 'to']), ('@601', ['<@600>', 'any']), ('@602', ['<@601>', 'of']), ('@603', ['<@602>', '<slot>']), ('@604', ['<@603>', 'passes']), ('@605', ['<@604>', 'through']), ('@606', ['<@605>', 'at']), ('@607', ['<@606>', 'least']), ('@608', ['<@607>', 'one']), ('@609', ['<@608>', 'of']), ('GeneralizedDominance', ['<@609>', '<slot>'])]"
